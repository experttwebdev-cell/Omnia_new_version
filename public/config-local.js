// LOCAL DEVELOPMENT ONLY - DO NOT COMMIT TO GIT
// This file is for local testing of HTML files
// In production, inject-env.sh will create config.js with real values
window.ENV = {
